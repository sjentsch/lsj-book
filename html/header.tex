...
%\usepackage{pdfpages} % for adding in the cover page, DO NOT USE FOR HTLATEX
...
%    {\vspace*{6pt} \small\underline{\texttt{#1}}\vspace*{-3pt}}
%\newcommand{\cmt}[1]
%    {\textcolor{Rboxcol}{#1}} % script commment command

% define the rtext, rtextsmall, rtextverb and rtextsmallverb
% commands. the small version is for use in margin paragraphs,
% so the font colour changes accordingly
\newcommand{\rtext}[1]
...
\newcommand{\rtextverb}[1]
    {\texttt{\small\textcolor{Rtextcol}{#1}}}

\newcommand{\rtextsmallverb}[1]
    {\texttt{\scriptsize\textcolor{Rtextmar}{#1}}}
...
\newcommand{\bmgrey}[1]
    {\textcolor{bmgreycol}{\bm{#1}}}
\newcommand{\fngrey}[1]
    {\textcolor{bmgreycol}{#1}}
\newcommand{\FOOTNOTE}[1]
    {\footnote{\protect\fngrey{#1}}}
...
%    {\parbox[t]{#1}{\dotfill}}
%\newcommand{\HR}
%    {\vspace*{3pt}  \dotrule{1.0\textwidth}}

% --- SOFTCOPY version ---
\definecolor{keytermcol}{rgb}{.6,0,.8} % soft copy
\newcommand{\keyterm}[1]
    {{\bf \textcolor{keytermcol}{#1}}}{\index{#1}}
